...
data <- data.table::fread("../../results/thymectomy_clone_dist_data_collapsed_naive_cleanup.csv")
...
ggsave(filename = "../../figures/binless_abundance_combined_collapsed.png",
       plot = thymectomy_clone_abundance_combined_plot,
       width=17,height=18.4, unit = "cm")

ggsave(filename = "../../figures/binless_abundance_combined_collapsed.pdf",
       plot = thymectomy_clone_abundance_combined_plot,
       width=17,height=18.4, unit = "cm")
